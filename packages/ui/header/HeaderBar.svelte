<!--
    ...
    @openmath/ui/header/Header.svelte
...
<div class="z-50 fixed top-0 h-auto w-full flex flex-col">
    <!-- Navbar -->
    <div class="top-0 h-12 w-full grid grid-cols-2 grid-rows-1 lg:grid-cols-3 {boxBackgroundColor} {boxTextColor} backdrop-filter backdrop-blur-lg bg-opacity-25 shadow-md">
        <!-- Navbar Logo -->
        <div class="pl-10 flex justify-start items-center cursor-pointer" title="OpenMath">
            <a class="h-full items-center p-3 font-mono font-semibold {menu} {boxButtonTextColor} {boxButtonHoverTextColor} cursor-pointer" href="/">OpenMath</a>
        </div>
        <!-- Menus -->
        <div class="hidden lg:flex justify-center items-center">
                <a class="h-full m-0 p-3 flex flex-row justify-center align-center {menu} {boxButtonTextColor} {boxButtonHoverTextColor} cursor-pointer" title="Home" href="/home">
                    <Fa class="mt-1 mr-1" icon={faHouse} size="md"/>
                    <p class="m-0">Home</p>
                </a>
                <a class="h-full m-0 p-3 flex flex-row justify-center align-center {menu} {boxButtonTextColor} {boxButtonHoverTextColor} cursor-pointer" title="Calculators" href="/calculators">
                ...
                <a class="h-full m-0 p-3 flex flex-row justify-center align-center {menu} {boxButtonTextColor} {boxButtonHoverTextColor} cursor-pointer" title="Help" href="/help">
        ...
        <div class="pt-1 pb-1 pr-10 flex justify-end items-center">
            ...
            <div
                ...
                class="hidden lg:flex h-full items-center rounded-full {menu} {boxButtonTextColor} {boxButtonHoverTextColor} cursor-pointer"
                title="Themes"
            >
            ...
            <div 
                ...
                class="hidden lg:flex h-full items-center overflow-hidden rounded-full {menu} {boxButtonTextColor} {boxButtonHoverTextColor} cursor-pointer"
                title="Account"
            >
            ...
            <div 
                ...
                class="flex lg:hidden h-9 w-9 items-center rounded-full {menu} {boxButtonTextColor} {boxButtonHoverTextColor} cursor-pointer"
                title="Menu"
            >
